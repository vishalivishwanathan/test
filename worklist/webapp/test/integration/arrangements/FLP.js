...
sap.ui.define([
	...
	"worklist/worklist/test/flpSandbox"
], function (Opa5, HashChanger, includeStylesheet, FakeLrepConnectorLocalStorage, mockserver, flpSandbox) {
	"use strict";
	...
	return Opa5.extend("worklist.worklist.test.integration.arrangements.FLP", {
		/**
